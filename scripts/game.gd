...
@onready var bomb_counter = $Control/PanelContainer/Rows/ColorRect3/BombRows/BombColumns
@onready var resource_counter = $Control/PanelContainer/Rows/ColorRect/VBoxContainer/Resource

#This sucks but whatever
@onready var bug_row_1 = $Control/PanelContainer/Rows/ColorRect/VBoxContainer/BugMarket/BugRow1
@onready var bug_row_2 = $Control/PanelContainer/Rows/ColorRect/VBoxContainer/BugMarket/BugRow2
